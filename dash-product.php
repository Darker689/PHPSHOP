...
if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['delete_id']) && isset($_POST['main_img'])) {
    $delete = Product::delete($_POST['delete_id']);
}
        ...
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                ...
                <div class="w-full flex items-center justify-between p-3">
                    ...
                    <div>
                        <a href="./dash-product-create.php">
                            <button class=" bg-blue-600 dark:bg-gray-100 text-white dark:text-gray-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 dark:hover:bg-gray-200 transition ease-in-out duration-300">Add Product</button>
                        </a>
                    </div>
                </div>
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                        ...
                                        <th class="px-4 py-3">category_tag</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <?php foreach ($products as $product) : ?>
                                        <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">$<?= $product['discount'] ?></td>
                                            <td class="px-4 py-3 text-sm"><?= $product['category'] ?></td>
                                            <td class="px-4 py-3 text-sm"><?= $product['category_tag'] ?></td>
                                            <td class="px-4 py-3 text-sm"><?= $product['count'] ?></td>
                                            <td class="px-4 py-3 text-sm"><?= $product['created_at'] ?></td>
                                            <td class="px-4 py-3 text-sm">
                                                <a href="./dash-product-show.php?id=<?= $product['id'] ?>">
                                                    <button class="px-3 py-1 text-white dark:text-gray-800 transition-colors duration-150 bg-green-600 dark:bg-gray-100 border border-r-0 border-green-600 dark:border-gray-100 rounded-md focus:outline-none focus:shadow-outline-purple"><i class="bi bi-eye-fill"></i></button>
                                                </a>
                                                <a href="./dash-product-edit.php?id=<?= $product['id'] ?>">
                                                    <button class="px-3 py-1 text-white dark:text-gray-800 transition-colors duration-150 bg-blue-600 dark:bg-gray-100 border border-r-0 border-green-600 dark:border-gray-100 rounded-md focus:outline-none focus:shadow-outline-purple"><i class="bi bi-pencil"></i></button>
                                                </a>
                                                <form action="" class="inline" method="POST" onsubmit="confirm('Really shut up')">
                                                    <input type="hidden" name="main_img" value="<?= $product['main_img']; ?>">
                                                    <input type="hidden" name="delete_id" value="<?= $product['id'] ?>">
                                                    <button type="delete" class="px-3 py-1 text-white dark:text-gray-800 transition-colors duration-150 bg-red-600 dark:bg-gray-100 border border-r-0 border-green-600 dark:border-gray-100 rounded-md focus:outline-none focus:shadow-outline-purple"><i class="bi bi-trash"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
