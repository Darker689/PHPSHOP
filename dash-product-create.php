...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['add_product'])) {
    ...
    Product::create($_POST['name'], $_POST['price'], $_POST['discount'], $_POST['category'], $_POST['category_tag'], $_POST['count'], $main_img);
}
        ...
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                <div class="w-full flex items-center justify-between p-3">
                    <h1 class="text-3xl font-bold">Product create</h1>
                </div>
                        ...
                        <div class="mt-5 md:col-span-2 md:mt-0">
                            <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="bg-white px-4 py-5 sm:p-6">
                                        <div class="grid grid-cols-9 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                <input type="text" name="name" required placeholder="Product name" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none">
                                            </div>

                                            <div class="col-span-6 sm:col-span-3">
                                                <input type="text" name="price" placeholder="Price" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none">
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                <input type="number" name="discount" placeholder="Discount" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none">
                                            </div>

                                            <div class="col-span-6 sm:col-span-3">
                                                <label class="block text-sm font-medium text-gray-700">Category</label>
                                                <select name="category" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <select name="category_tag" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="number" name="count" placeholder="Count" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none">
                                            </div>
                                ...
                                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                    <button type="add_product" name="add_product" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Save</button>
                                </div>
                        </div>
                        </form>
                    </div>
