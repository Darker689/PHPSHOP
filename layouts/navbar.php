...
<!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-light bg-white flex-column border-0 position-fixed top-0 bg-white">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <ul class="list-unstyled mb-0 d-flex align-items-center order-1 order-lg-2 nav-sidelinks">
                    ...
                    <li class="ms-1 d-inline-block position-relative dropdown-cart">
                        <a href="../cart.php" class="nav-link me-0 disable-child-pointer border-0 p-0 bg-transparent text-body" type="button">
                            Bag (2)
                        </a>
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        <?php foreach ($categories as $category) : ?>
                            <li class="nav-item dropdown dropdown position-static">
                                <a class="nav-link dropdown-toggle" href="./category.php?category=<?= $category['name'] ?>" aria-expanded="false">
                                    <?= $category['name'] ?>
                                </a>
                            </li>
                        <?php endforeach; ?>
