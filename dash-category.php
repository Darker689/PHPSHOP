...
if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['delete_id'])) {
    $delete = Category::delete($_POST['delete_id']);
}

// Category Tags
$category_tags = Category_Tag::index();

if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['add_category_tag'])) {
    Category_Tag::create($_POST['category_id'], $_POST['name']);
}

if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['delete_idd'])) {
    $delete = Category_Tag::delete($_POST['delete_idd']);
}
...
<body class="bg-gray-200">
    ...
    <div x-data="setup()" :class="{ 'dark': isDark }">
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64 grid grid-cols-2 gap-5">
                    ...
                    <div class="w-full flex items-center justify-between p-3">
                        ...
                        <div>
                            <form action="" method="POST">
                                <input type="text" name="name" class="focus:outline-none focus:ring focus:border-blue-500 border border-blue-500 p-3" placeholder="Category Name">
                                <button type="submit" name="submit" class=" bg-blue-600 dark:bg-gray-100 text-white dark:text-gray-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 dark:hover:bg-gray-200 transition ease-in-out duration-300">Add Category</button>
                            </form>
                        </div>
                    </div>
                    <!-- ./Statistics Cards -->
                                            ...
                                            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3 text-sm">
                                                    <form action="" method="POST" onsubmit="confirm('Really shut up')">
                                                        ...
                                                        <button type="submit" class="rounded bg-red-700 text-white p-3">
                ...
                <div>
                    <!-- Statistics Cards -->
                    <div class="w-full flex items-center justify-between p-3">
                        <h1 class="text-3xl font-bold">Category Tag</h1>

                        <div>
                            <form action="" method="POST">
                                <input type="text" name="name" class="focus:outline-none focus:ring focus:border-blue-500 border border-blue-500 p-3" placeholder="Category Tag Name">
                                <select name="category_id" class="focus:outline-none focus:ring focus:border-blue-500 border border-blue-500 p-3">
                                    <?php foreach ($categories as $category) : ?>
                                        <option value="<?= $category['id'] ?>"><?= $category['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <button type="add_category_tag" name="add_category_tag" class=" bg-blue-600 dark:bg-gray-100 text-white dark:text-gray-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 dark:hover:bg-gray-200 transition ease-in-out duration-300">Add Category Tag</button>
                            </form>
                        </div>
                    </div>
                    <!-- ./Statistics Cards -->
                                ...
                                <table class="w-full">
                                    ...
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        <?php foreach ($category_tags as $category_tag) : ?>
                                            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3">
                                                    <p class="font-semibold"><?= $category_tag['id'] ?></p>
                                                </td>
                                                <td class="px-4 py-3 text-sm"><?= $category_tag['category_id'] ?></td>
                                                <td class="px-4 py-3 text-sm"><?= $category_tag['name'] ?></td>
                                                <td class="px-4 py-3 text-sm">
                                                    <form action="" method="POST" onsubmit="confirm('Really shut up')">
                                                        <input type="hidden" name="delete_idd" value="<?= $category_tag['id'] ?>">
                                                        <button type="submit" class="rounded bg-red-700 text-white p-3">
                                                            <i class="bi bi-trash3-fill"></i>
                                                        </button>
                                                    </form>
