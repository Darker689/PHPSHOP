...
$edit = Product::show($_GET['id']);

if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST != null) {

    $products = Product::index();

    $extra = count($products);
    ...
    Product::edit($_POST['name'], $_POST['price'], $_POST['discount'], $_POST['category'], $_POST['category_tag'], $_POST['count'], $main_img, $_POST['edit_id']);
}
...
$category_tags = Category_Tag::index();
                        ...
                        <div class="mt-5 md:col-span-2 md:mt-0">
                            <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="bg-white px-4 py-5 sm:p-6">
                                        <div class="grid grid-cols-9 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                <input type="text" name="name" required placeholder="Product name" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" value="<?= $edit['name']; ?>">
                                            </div>

                                            <div class="col-span-6 sm:col-span-3">
                                                <input type="text" name="price" placeholder="Price" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" value="<?= $edit['price']; ?>">
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                <input type="number" name="discount" placeholder="Discount" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" value="<?= $edit['discount']; ?>">
                                            </div>

                                            <div class="col-span-6 sm:col-span-3">
                                                <label class="block text-sm font-medium text-gray-700">Category</label>
                                                <select name="category" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" value="<?= $edit['category']; ?>">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <select name="category_tag" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" value="<?= $edit['category_tag']; ?>">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="number" name="count" placeholder="Count" class="w-full mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" value="<?= $edit['count']; ?>">
                                            </div>

                                            <div class="w-[1100%]">
                                                <img src="<?= $edit['main_img']; ?>" alt="">
                                                <label class="w-full block text-sm font-medium text-gray-700">Cover photo</label>
                                                <div class="w-full mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                                                    <div class="w-full space-y-1 text-center">
                                                        <svg class="w-full mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                                        ...
                                                        <div class="flex text-sm text-gray-600">
                                                            <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">
                                                                ...
                                                                <input id="file-upload" name="old_img" type="hidden" value="<?= $edit['main_img']; ?>">
                                                            </label>
                                ...
                                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                    <button type="edit_product" name="edit_product" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Save</button>
                                </div>
                        </div>
                        </form>
                    </div>
