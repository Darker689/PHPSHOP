...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit'])) {
    Country::create($_POST['name']);
}

if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['delete_id'])) {
    $delete = Country::delete($_POST['delete_id']);
}
        ...
        <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                ...
                <div class="w-full flex items-center justify-between p-3">
                    <h1 class="text-3xl font-bold">Countires</h1>

                    <div>
                        <form action="" method="POST">
                            <input type="text" name="name" class="focus:outline-none focus:ring focus:border-blue-500 border border-blue-500 p-3" placeholder="Country Name">
                            <button type="submit" name="submit" class=" bg-blue-600 dark:bg-gray-100 text-white dark:text-gray-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-500 dark:hover:bg-gray-200 transition ease-in-out duration-300">Add Country</button>
                        </form>
                    </div>
                </div>
                <!-- ./Statistics Cards -->
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <?php foreach ($countries as $country) : ?>
                                        <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                            <td class="px-4 py-3">
                                                <p class="font-semibold"><?= $country['id'] ?></p>
                                            </td>
