...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit'])) {
    Color::create($_POST['color_name']);
}

if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['delete_id'])) {
    $delete = Color::delete($_POST['delete_id']);
}
            ...
            <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
                ...
                <div>
                    ...
                    <div class="w-full flex items-center justify-between p-3">
                        <h1 class="text-3xl font-bold">Color</h1>

                        <div>
                            <form action="" method="POST">
                                <input type="text" name="color_name" class="focus:outline-none focus:ring focus:border-blue-500 border border-blue-500 p-3" placeholder="Color Name">
                                    ...
                                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                        <?php foreach ($colors as $color) : ?>
                                            <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                                <td class="px-4 py-3">
                                                    <p class="font-semibold"><?= $color['id'] ?></p>
                                                </td>
                                                <td class="px-4 py-3 text-sm"><?= $color['color_name'] ?></td>
                                                <td class="px-4 py-3 text-sm">
                                                    <form action="" method="POST" onsubmit="confirm('Really shut up')">
                                                        <input type="hidden" name="delete_id" value="<?= $color['id'] ?>">
